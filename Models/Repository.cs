...
namespace WebUygulama1.Models
{
    public class Repository<T> : IRepository<T> where T : class
    {
        ...
        public Repository(UygulamaDbContext uygulamaDbContext)
        {
            ...
            // Foreign key olarak id tutuyoruz ama o tablonun içinden metin yani bilgiyi çekmek istiyorsak(Roman, Hikaye...)
            // bu yapıyı kullanmalıyız. Include metodu bu işe yarar. Tablodan veri çeken metodlarımız Get ve GetAll buralarda da
